  ...
  <div class="bg-gradient-to-r from-neutral-500 to-neutral-800 py-16">
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="space-y-8">
        ...
        <div class="bg-white shadow-md rounded-lg p-8">
          ...
          <div class="space-y-4">
            <div class="flex items-center space-x-4">
              ...
              <span class="text-gray-700 font-medium">+1 (555) 555-5555</span>
            </div>
            <div class="flex items-center space-x-4">
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="flex items-center space-x-4">
              ...
              <span class="text-gray-700 font-medium"
                >123 Main St, Anytown USA</span
              >
            </div>
          </div>
          <div class="mt-6">
            <a
              href="mailto:info@qindiwu.com?subject=Inquiry from Website"
        ...
        <!-- Follow Me Card -->
        <div class="bg-white shadow-md rounded-lg p-8">
          <h2 class="text-2xl font-bold mb-4">Follow Me</h2>
          <div class="space-y-4">
            <div class="flex items-center space-x-4">
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="flex items-center space-x-4">
              ...
              <a
                href="https://www.instagram.com/qindiwu"
                class="text-gray-700 font-medium hover:text-indigo-500 transition-colors"
                >Instagram</a
              >
            </div>
